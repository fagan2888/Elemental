...
*/
#pragma once
#ifndef CORE_DISTMATRIX_STAR_VC_DECL_HPP
#define CORE_DISTMATRIX_STAR_VC_DECL_HPP
...
{
public:
	typedef DistMatrix<T,STAR,VC,Int> Self;
	typedef DistMatrix<typename Base<T>::type,STAR,VC,Int> RSelf;
	...
	Distribution ColDist() const { return VC; }
	Distribution2D Dist2D() const { return STAR_VC; }
    ...
    DistMatrix( const DistMatrix<T,STAR,VC,Int>& A );
...
#endif // ifndef CORE_DISTMATRIX_STAR_VC_DECL_HPP
