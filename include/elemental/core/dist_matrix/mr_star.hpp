...
{
public:
	typedef DistMatrix<T,MR,STAR,Int> Self;
	typedef DistMatrix<typename Base<T>::type,MR,STAR,Int> RSelf;
	...
	Distribution2D Dist2D() const { return MR_STAR; }
    ...
    DistMatrix( const DistMatrix<T,MR,STAR,Int>& A );
