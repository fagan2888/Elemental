...
template<typename T,typename Int>
void
DistMatrix<T,STAR,MC,Int>::AlignWith( const AutoDistMatrix<Int>& A )
...
template<typename T,typename Int>
void
DistMatrix<T,STAR,MC,Int>::AlignRowsWith( const AutoDistMatrix<Int>& A )
{ this->AlignWith( A.DistData() ); }
